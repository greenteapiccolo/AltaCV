...
\begin{itemize}
  ...
  \item Multiple caching and threading used for performance on UI and API side
...
\begin{itemize}
  ...
  \item FTS-based team workflow
  \item Support and feedback handling
\end{itemize}
\begin{itshape}
...
\begin{minipage}[t]{0.45\textwidth}
  ...
  \begin{itemize}
    ...
    \item B2B CRM in TypeScript React.js
    \item Used centralized i18n internationalization for apps
    \item Worked on mobile applications push notification
    \item Template web code editor with Svelte
    \item Stripe 3DSV2 payment system integration
...
\begin{minipage}[t]{0.45\textwidth}
  ...
  Technical:
  \begin{itemize}
    \item Projects in monorepo design with some patterns (Factory etc.)
...
Other skills:
\begin{itemize}
  \item 99\% uptime B2C apps with external restrictions and deadlines and technical debt
  \item Collaboration with UI/UX designers, external teams
...
Notes: self-taught; autonomous; alive project
