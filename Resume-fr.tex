...
\begin{minipage}[t]{0.45\textwidth}
  ...
  \begin{itemize}
    ...
    \item Outils liés à l'ITSM (planificateur, détails, recherche, versionning) en format web
...
\begin{minipage}[t]{0.45\textwidth}
  ...
  \begin{itemize}
    ...
    \item Utilisation de plusieurs méthodes de cache et de threading pour améliorer les performances côté UI et API
